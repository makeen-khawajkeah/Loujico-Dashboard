...
const Login = () => {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            const response = await axios.post('http://192.168.1.10:7176/api/Account/Login', {
                Email,
                Password,
            }, {
        ...
        <div className="flex justify-center items-center h-screen bg-gray-100">
            <div className="w-full max-w-md p-8 space-y-6 bg-white rounded-xl shadow-lg">
                <div className="text-center">
                    <img src="/public/assets/image/logo.png" alt="Company Logo" className="mx-auto h-24 w-auto mb-4" />
                ...
                <form className="space-y-6" onSubmit={handleLogin}>
                    ...
                    <div className="flex items-center justify-between">
                        <div className="text-sm">
                            <a href="#" className="font-medium text-[var(--main-color)] hover:text-[var(--main-color-lighter)]">
